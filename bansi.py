...
#
# Also, some handy-to-type pfp*() routines to print
# without separators, and to flush stdout (for ansi to work live)
...
#
# *NOTE: I included these now.  See the end of this file for those.
#
